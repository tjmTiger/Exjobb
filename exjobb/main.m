...
% TEST(@test_size, "", "", "Size", 100:50:200, "fract_targ", 0.3, "sample_size", 500, "boxchart", true)
...
% TEST(@test_size, "", "", "Size", 100:50:200, "fract_targ", 0.3, "sample_size", 500, "ddp", "output_feedback", "boxchart", true)
...
% TEST(@test_size, "", "", "Size", 100:50:200, "fract_targ", 0.3, "sample_size", 500, "ddp", "dynamical_feedback", "boxchart", true)
% TEST(@test_node_degree, "", "", "AverageDegree", 2:1:7, "sample_size", 500, "ddp", "dynamical_feedback", "boxchart", true)
% TEST(@test_strogatz_fraction_beta, "Fractions", 0.05:0.05:0.3, "Beta", 0:0.1:1, "graph_generating_algorithm", "Watts Strogratz", "sample_size", 500, "ddp", "dynamical_feedback")
% TEST(@test_strogatz_size_beta, "Size", 100:50:200, "Beta", 0:0.1:1, "graph_generating_algorithm", "Watts Strogratz", "sample_size", 500, "ddp", "dynamical_feedback")
% TEST(@test_scale_fraction_alphagamma, "Fractions", 0.05:0.05:0.3, "Alpha", 0:0.1:1, "graph_generating_algorithm", "Scale Free", "sample_size", 500, "ddp", "dynamical_feedback")
% TEST(@test_scale_fraction_beta, "Fractions", 0.05:0.05:0.3, "Beta", 0:0.1:0.8, "graph_generating_algorithm", "Scale Free", "sample_size", 500, "ddp", "dynamical_feedback")
% TEST(@test_scale_size_alphagamma, "Size", 100:50:200, "Alpha", 0:0.1:1, "graph_generating_algorithm", "Scale Free", "sample_size", 500, "ddp", "dynamical_feedback")
% TEST(@test_scale_size_beta, "Size", 100:50:200, "Beta", 0:0.1:0.8, "graph_generating_algorithm", "Scale Free", "sample_size", 500, "ddp", "dynamical_feedback")
