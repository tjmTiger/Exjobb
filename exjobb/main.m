...
% TEST(@test_strogatz_fraction_beta, "Fractions", 0.05:0.05:0.3, "$p_{ws}$", 0:0.1:1, "graph_generating_algorithm", "Watts Strogratz", "sample_size", 500)
% TEST(@test_strogatz_size_beta, "Size", 100:50:200, "$p_{ws}$", 0:0.1:1, "graph_generating_algorithm", "Watts Strogratz", "sample_size", 500)
...
% TEST(@test_strogatz_fraction_beta, "Fractions", 0.05:0.05:0.3, "$p_{ws}$", 0:0.1:1, "graph_generating_algorithm", "Watts Strogratz", "sample_size", 500, "ddp", "output_feedback")
% TEST(@test_strogatz_size_beta, "Size", 100:50:200, "$p_{ws}$", 0:0.1:1, "graph_generating_algorithm", "Watts Strogratz", "sample_size", 500, "ddp", "output_feedback")
...
% TEST(@test_OFDF_strogatz_beta, "Feedback", ["output_feedback", "dynamical_feedback"], "$p_{ws}$", 0:0.1:1, "graph_generating_algorithm", "Watts Strogratz", "sample_size", 500, "size", 50, "default_p", default_p)
