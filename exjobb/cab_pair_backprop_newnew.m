...
function [V_out, V_in, TotalCost, S_Min, Z_Max] = cab_pair_backprop_newnew(G, D, T, max_V)
...
%                         if isSubset1 && isSubset2 && isSubset3
                        if isSubset1 && isSubset2
                            ...
                            % return early if cheap enough solution found
                            if numel(V_in)+numel(V_out) <= max_V
                                return
                            end
